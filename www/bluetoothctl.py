...
# Updated for Python 3.6.8 on a Raspberry  Piget_available_devices
...
if __name__ == "__main__":
    ...
    #b2 = Bluetoothctl()
    Bluetoothctl().trust("E4:F0:42:51:C7:72")
    Bluetoothctl().pair("E4:F0:42:51:C7:72")
    Bluetoothctl().connect("E4:F0:42:51:C7:72")
