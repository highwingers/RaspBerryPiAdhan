...
var s = (function () {
    ...
    return {
        ...
        updateSettings: function (url, address, speaker,speakername, method, asr, timezone, btn, callback) {
            ...
            $.ajax({
                ...
                dataType: 'text',
                method: 'POST',
                data: { 'address': address, 'speaker': speaker,'speakername':speakername, 'method': method, 'asr': asr, 'timezone': timezone },
                success: function (d) {
